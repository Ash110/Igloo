module.exports = template = (name,code) => `<!DOCTYPE html
...
<head>
    ...
    <title>Igloo Password Reset Instructions</title>
</head>
                    ...
                    <tr>
                        <td class="email-masthead"
                            ...
                            <a href="#" class="email-masthead_name"
                                ...
                                Igloo Password Reset Instructions
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                            align="left">
                                            A password reset request was sent to this account. If you have not initiated it, you can ignore this mail, your data is safe. However, if you would like to reset your password for your Igloo account, return to the Igloo App or Site and enter the following code to reset your password.
                                        </p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                style="-webkit-text-size-adjust: none; background: #22BC66; border-color: #22bc66; border-radius: 3px; border-style: solid; border-width: 10px 18px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16);font-size: 30px; box-sizing: border-box; color: #FFF; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-decoration: none;">${code}</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                            align="left">After you enter the code, you can enter a new password. Make sure it's a strong, un-guessable password.
                                            <br><br>
                                            Thanks for being a part of Igloo. Make sure you invite your friends over to the Private, Secure, Ad-Free Social Media.
                                        <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                            align="left">Thanks,
                                            <br />Team Igloo
                                        </p>
